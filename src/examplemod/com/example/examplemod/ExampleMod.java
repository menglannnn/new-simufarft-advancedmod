...
public class ExampleMod
{
    ...
    // Directly reference a slf4j logger!!ovo
    ...
    public ExampleMod()
    {
        ...
        // 注册NPC恋爱系统事件处理器
        MinecraftForge.EVENT_BUS.register(NPCLoveHandler.class);
        ...
        // 初始化新模拟大都市集成
        SimulatedNightmaresIntegration.init();
    }
    ...
    public static class ClientModEvents
    {
        ...
        public static void onClientSetup(FMLClientSetupEvent event)
        {
            ...
            event.enqueueWork(DialogueScriptLoader::initializeRuntimeScriptIfNeeded);
        }
    }
}
